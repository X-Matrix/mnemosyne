...
// Use fancy-regex when: (a) building for wasm, OR (b) onig C-library feature is
// not requested. This lets the crate compile without the oniguruma system lib.
#[cfg(any(feature = "unstable_wasm", not(feature = "onig")))]
mod fancy;
#[cfg(any(feature = "unstable_wasm", not(feature = "onig")))]
pub use fancy::SysRegex;
// Only compile the onig (C-library backed) module when the feature is explicitly
// requested AND we are not targeting wasm.
#[cfg(all(not(feature = "unstable_wasm"), feature = "onig"))]
mod onig;
#[cfg(all(not(feature = "unstable_wasm"), feature = "onig"))]
